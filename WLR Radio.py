...
TOKEN = "OTU2NzUzNTcxNzg3OTc2NzU0.GZ7P42.hzU0FkG3TI5AVhR8vcWBJNT7yMHcB-w9b8LhGE"
...
AUDIO_PATH = r'C:\Users\AT\WLR\WLR Playlist\20230512'
AUDIO_FILES = [AUDIO_PATH+'\imogen pre-voice.mp3',
               AUDIO_PATH+'\Imogen_Heap_-_Hide_and_Seek_Avicii_Remix.mp3',
               AUDIO_PATH+'\hardwell pre-voice.mp3',
               AUDIO_PATH+'\Hardwell - BLACK MAGIC (Extended Mix).mp3', 
